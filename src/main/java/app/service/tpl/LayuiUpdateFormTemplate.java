 ...
 */
@Service
public class LayuiUpdateFormTemplate extends AbstractTemplate {
    @Override
    protected String gen(JdbcTool.TableStruct model, Integer prefixLength) throws IOException {
        return renderBeetl(model, new ClassPathResource("/btl/layuiUpdateForm.btl"),prefixLength);
    }
    @Override
    protected String name() {
        return "LayuiUpdateForm";
    }
    @Override
    public String genFileName(String dataSource, String catalog, String schema, String table) {
        ...
        return lowerName + "/update" + upperName + ".jsp";
    }
}
