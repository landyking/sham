 ...
 */
@Service
public class ListControllerTemplate extends AbstractTemplate {
    @Override
    protected String gen(JdbcTool.TableStruct model, Integer prefixLength) throws IOException {
        return renderBeetl(model, new ClassPathResource("/btl/listController.btl"),prefixLength);
    }
    @Override
    ...
    public String genFileName(String dataSource, String catalog, String schema, String table) {
        ...
        return lowerName + "/List" + upperName + "Controller.java";
    }
}
